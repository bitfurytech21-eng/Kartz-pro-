...
export const defaultFamilyMembers: FamilyMember[] = [
  ...
  {
    id: 'advisor',
    name: 'Senior Partner & Private Office',
    role: 'Partner & Private Client Advisory',
    location: 'Paris Prime & International Hubs',
    photoFilename: 'IMG_6416.jpeg',
    initials: 'KP',
    bio: 'Advising ultra-high-net-worth individuals, institutional estates, and private collections across Europe and international luxury capitals.',
    landmarkSale: '€28,000,000 Trophy Asset on Boulevard Saint-Germain',
    phone: '+33 1 41 10 00 00',
    email: 'contact@kretz.site',
  },
  {
    id: 'majo',
    name: 'Majo (Mireille)',
